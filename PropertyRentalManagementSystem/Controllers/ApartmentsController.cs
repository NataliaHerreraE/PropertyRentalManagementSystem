...
namespace PropertyRentalManagementSystem.Controllers
{
    public class ApartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ApartmentId,BuildingId,AppartmentNumber,Rooms,Bathrooms,DateListed,StatusId,ImagePath")] Apartment apartment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ApartmentId,BuildingId,AppartmentNumber,Rooms,Bathrooms,DateListed,StatusId,ImagePath")] Apartment apartment)
        {
            if (ModelState.IsValid)
            {
